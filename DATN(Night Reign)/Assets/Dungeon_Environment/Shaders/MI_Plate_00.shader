...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,0.000000);//UVTiling Normal_Intensity (Unknown) BaseColorDesaturation
	Material.ScalarExpressions[1] = float4(1.000000,41.530663,76.265198,0.000000);//Brightness Metallic Roughness_Strength Displacement
