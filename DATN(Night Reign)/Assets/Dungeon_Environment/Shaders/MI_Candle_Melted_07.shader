Shader "Unreal/MI_Candle_Melted_07"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.323143,0.181164,0.114435,1.000000);//SSS
	Material.VectorExpressions[5] = float4(0.323143,0.181164,0.114435,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,0.000000,0.000000);//Normal Flatness (S) (Unknown) Hue (Unknown)
	Material.ScalarExpressions[1] = float4(0.190476,0.000000,0.000000,1.000000);//Brightness Desaturation Lighten Metallic
	Material.ScalarExpressions[2] = float4(4.000000,1.000000,0.000000,0.000000);//Roughness Opacity __SubsurfaceProfile (Unknown)
}
MaterialFloat3 CustomExpression0(FMaterialPixelParameters Parameters,MaterialFloat3 In1,MaterialFloat In2)
{
return max(In1, In2)
;
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local5 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 4);
	...
	MaterialFloat3 Local8 = RotateAboutAxis(MaterialFloat4((MaterialFloat3(1.00000000,1.00000000,1.00000000) / sqrt(dot(MaterialFloat3(1.00000000,1.00000000,1.00000000),MaterialFloat3(1.00000000,1.00000000,1.00000000)))),Material.ScalarExpressions[0].w),MaterialFloat3(0.00000000,0.00000000,0.00000000),Local6.rgb);
	MaterialFloat3 Local9 = (Local8 + Local6.rgb);
	MaterialFloat3 Local10 = (Material.ScalarExpressions[1].x * Local9);
	MaterialFloat Local11 = dot(Local10, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local12 = lerp(Local10,MaterialFloat3(Local11,Local11,Local11),MaterialFloat(Material.ScalarExpressions[1].y));
	MaterialFloat3 Local13 = (Material.VectorExpressions[3].rgb * Local12);
	MaterialFloat3 Local14 = CustomExpression0(Parameters,Local13,Material.ScalarExpressions[1].z);
	MaterialFloat Local15 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 3);
	MaterialFloat4 Local16 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local17 = MaterialStoreTexSample(Parameters, Local16, 3);
	MaterialFloat Local18 = (Material.ScalarExpressions[1].w * Local16.b);
	MaterialFloat Local19 = (Material.ScalarExpressions[2].x * Local16.g);

	PixelMaterialInputs.EmissiveColor = Local4;
	PixelMaterialInputs.Opacity = Material.ScalarExpressions[2].y;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Material.VectorExpressions[5].rgb,Material.ScalarExpressions[2].z);
	PixelMaterialInputs.AmbientOcclusion = Local16.r;
