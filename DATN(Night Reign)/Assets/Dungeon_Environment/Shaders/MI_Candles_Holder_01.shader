Shader "Unreal/MI_Candles_Holder_01"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(1.000000,0.679543,0.485150,1.000000);//Tint
	Material.VectorExpressions[3] = float4(1.000000,0.679543,0.485150,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,0.000000,0.000000);//Normal Flatness (S) (Unknown) Hue (Unknown)
	Material.ScalarExpressions[1] = float4(2.490680,0.456361,0.000000,1.707873);//Brightness Desaturation Lighten Metallic
	Material.ScalarExpressions[2] = float4(5.345745,0.000000,0.000000,0.000000);//Roughness (Unknown) (Unknown) (Unknown)
}
