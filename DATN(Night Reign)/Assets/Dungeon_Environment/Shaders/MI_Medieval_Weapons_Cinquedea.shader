Shader "Unreal/MI_Medieval_Weapons_Cinquedea"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[1] = float4(0.000000,7.229710,0.500000,0.000000);//BloodStrength Roughness_Strength AO_Strength (Unknown)
}
