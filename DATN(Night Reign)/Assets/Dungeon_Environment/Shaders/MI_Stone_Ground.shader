...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.000000,0.000000,0.000000,1.000000);//BaseColorLightness
	Material.VectorExpressions[3] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(20.000000,0.000000,0.000000,0.000000);//UVTiling Normal_Intensity (Unknown) BaseColorDesaturation
	Material.ScalarExpressions[1] = float4(0.100000,1.000000,0.200000,0.000000);//Brightness Metallic Roughness_Strength Displacement
	Material.ScalarExpressions[2] = float4(4.000000,0.500000,0.000000,0.000000);//Tessellation Multiplier AO_Strength (Unknown) (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local1 = MaterialStoreTexCoordScale(Parameters, Local0, 4);
	...
	MaterialFloat Local3 = MaterialStoreTexSample(Parameters, Local2, 4);
	MaterialFloat3 Local4 = lerp(Local2.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),MaterialFloat(Material.ScalarExpressions[0].y));
	...
	MaterialFloat3 Local5 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[1].rgb,MaterialFloat(Material.ScalarExpressions[0].z));
	MaterialFloat Local6 = MaterialStoreTexCoordScale(Parameters, Local0, 5);
	MaterialFloat4 Local7 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_1, GetMaterialSharedSampler(Material_Texture2D_1Sampler,View.MaterialTextureBilinearWrapedSampler),Local0));
	MaterialFloat Local8 = MaterialStoreTexSample(Parameters, Local7, 5);
	MaterialFloat Local9 = dot(Local7.rgb, MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local10 = lerp(Local7.rgb,MaterialFloat3(Local9,Local9,Local9),MaterialFloat(Material.ScalarExpressions[0].w));
	MaterialFloat3 Local11 = CustomExpression0(Parameters,Local10,Material.VectorExpressions[3].rgb);
	MaterialFloat3 Local12 = (Material.ScalarExpressions[1].x * Local11);
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, Local0, 1);
	MaterialFloat4 Local14 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_2, GetMaterialSharedSampler(Material_Texture2D_2Sampler,View.MaterialTextureBilinearWrapedSampler),Local0));
	MaterialFloat Local15 = MaterialStoreTexSample(Parameters, Local14, 1);
	MaterialFloat Local16 = (Material.ScalarExpressions[1].y * Local14.b);
	MaterialFloat Local17 = (Material.ScalarExpressions[1].z * Local14.g);
	MaterialFloat Local20 = (Material.ScalarExpressions[2].y * Local14.r);

	PixelMaterialInputs.EmissiveColor = Local5;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local12;
	PixelMaterialInputs.Metallic = Local16;
