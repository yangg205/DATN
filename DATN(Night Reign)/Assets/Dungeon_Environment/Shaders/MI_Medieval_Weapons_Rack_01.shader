Shader "Unreal/MI_Medieval_Weapons_Rack_01"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.ScalarExpressions[1] = float4(0.000000,1.293037,3.000000,0.000000);//BloodStrength Roughness_Strength AO_Strength (Unknown)
}
