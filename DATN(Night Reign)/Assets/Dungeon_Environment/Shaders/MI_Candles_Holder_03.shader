Shader "Unreal/MI_Candles_Holder_03"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(1.000000,0.604499,0.364583,1.000000);//Tint
	Material.VectorExpressions[3] = float4(1.000000,0.604499,0.364583,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.908015,0.000000,0.000000,0.000000);//Normal Flatness (S) (Unknown) Hue (Unknown)
	Material.ScalarExpressions[1] = float4(1.250987,0.000000,0.000000,1.638905);//Brightness Desaturation Lighten Metallic
	Material.ScalarExpressions[2] = float4(4.787517,0.000000,0.000000,0.000000);//Roughness (Unknown) (Unknown) (Unknown)
}
