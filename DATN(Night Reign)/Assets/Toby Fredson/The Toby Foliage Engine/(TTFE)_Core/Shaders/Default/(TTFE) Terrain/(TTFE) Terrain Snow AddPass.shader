...
Shader "Toby Fredson/The Toby Foliage Engine/(TTFE) Terrain Snow AddPass"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf StandardSpecular keepalpha vertex:vertexDataFunc  decal:blend finalcolor:SplatmapFinalColor
		struct Input
		{
			float2 vertexToFrag286_g16;
			float2 uv_texcoord;
		};
...
void ApplyMeshModification( inout appdata_full v )
{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float localCalculateTangentsStandard706_g16 = ( 0.0 );
			{
			v.tangent.xyz = cross ( v.normal, float3( 0, 0, 1 ) );
			v.tangent.w = -1;
			}
			float3 ase_vertexNormal = v.normal.xyz;
			float3 temp_output_707_0_g16 = ( localCalculateTangentsStandard706_g16 + ase_vertexNormal );
			v.normal = temp_output_707_0_g16;
			float4 appendResult704_g16 = (float4(cross( ase_vertexNormal , float3(0,0,1) ) , -1.0));
			v.tangent = appendResult704_g16;
			float2 break291_g16 = _Control_ST.zw;
			float2 appendResult293_g16 = (float2(( break291_g16.x + 0.001 ) , ( break291_g16.y + 0.0001 )));
			o.vertexToFrag286_g16 = ( ( v.texcoord.xy * _Control_ST.xy ) + appendResult293_g16 );
		}

		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			float4 tex2DNode283_g16 = SAMPLE_TEXTURE2D( _Control, sampler_Control, i.vertexToFrag286_g16 );
			...
			float3 weightedBlend473_g16 = ( weightedBlendVar473_g16.x*UnpackScaleNormal( Normal0341_g16, _NormalScale0 ) + weightedBlendVar473_g16.y*UnpackScaleNormal( Normal1378_g16, _NormalScale1 ) + weightedBlendVar473_g16.z*UnpackScaleNormal( Normal2356_g16, _NormalScale2 ) + weightedBlendVar473_g16.w*UnpackScaleNormal( Normal3398_g16, _NormalScale3 ) );
			...
			float3 weightedBlend9_g16 = ( weightedBlendVar9_g16.x*Splat0342_g16 + weightedBlendVar9_g16.y*Splat1379_g16 + weightedBlendVar9_g16.z*Splat2357_g16 + weightedBlendVar9_g16.w*Splat3390_g16 );
			...
			o.Albedo = localClipHoles453_g16;
			...
			float temp_output_56_45 = dotResult1166_g16;
			float3 temp_cast_6 = (saturate( ( weightedBlend536_g16 + ( temp_output_56_45 * _SpecularPower ) ) )).xxx;
			o.Specular = temp_cast_6;
			o.Smoothness = temp_output_56_45;
			...
			o.Occlusion = saturate( weightedBlend602_g16 );
			o.Alpha = dotResult278_g16;
		}
...
/*ASEBEGIN
Version=19701
Node;AmplifyShaderEditor.FunctionNode;56;-96,48;Inherit;False;(TTFE) Terrain 4 Layer;0;;16;cbdebdb4ac1110445ac18699eb78ddd1;2,504,1,102,1;0;8;FLOAT3;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;282;FLOAT3;709;FLOAT4;701
Node;AmplifyShaderEditor.RangedFloatNode;69;-96,304;Inherit;False;Property;_SpecularPower;Specular Power;29;1;[Header];Create;True;1;(Specular);0;0;False;0;False;1;0.012;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;67;192,240;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;70;352,112;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;74;144,32;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode;73;160,64;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WireNode;59;608,272;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;71;480,112;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;58;192,448;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.WireNode;57;208,416;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode;75;576,64;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode;76;576,32;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;644.0565,42.11808;Float;False;True;-1;3;;0;0;StandardSpecular;Toby Fredson/The Toby Foliage Engine/(TTFE) Terrain Snow AddPass;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;;3;False;;False;0;False;;0;False;;False;0;Custom;0.5;True;False;-99;True;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;Hidden/TerrainEngine/Splatmap/Diffuse-AddPass;28;-1;-1;-1;2;TerrainCompatible=True;IgnoreProjector=True;False;0;0;False;;-1;0;False;;12;Pragma;instancing_options assumeuniformscaling nomatrices nolightprobe nolightmap forwardadd;False;;Custom;False;0;0;;Pragma;multi_compile_local __ _NORMALMAP;False;;Custom;False;0;0;;Pragma;shader_feature_local _MASKMAP;False;;Custom;False;0;0;;Pragma;multi_compile_local_fragment __ _ALPHATEST_ON;False;;Custom;False;0;0;;Pragma;multi_compile_fog;False;;Custom;False;0;0;;Pragma;editor_sync_compilation;False;;Custom;False;0;0;;Pragma;target 3.0;False;;Custom;False;0;0;;Pragma;exclude_renderers gles;False;;Custom;False;0;0;;Define;TERRAIN_SPLATMAP_COMMON_CGINC_INCLUDED;False;;Custom;False;0;0;;Include;TerrainSplatmapCommon.cginc;False;;Custom;False;0;0;;Define;TERRAIN_SPLAT_ADDPASS;False;;Custom;False;0;0;;Define;TERRAIN_STANDARD_SHADER;False;;Custom;False;0;0;;2;decal:blend;finalcolor:SplatmapFinalColor;0;True;0.1;False;;0;False;;True;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
WireConnection;67;0;56;45
WireConnection;67;1;69;0
WireConnection;70;0;56;56
WireConnection;70;1;67;0
WireConnection;74;0;56;0
WireConnection;73;0;56;14
WireConnection;59;0;56;282
WireConnection;71;0;70;0
WireConnection;58;0;56;701
WireConnection;57;0;56;709
WireConnection;75;0;73;0
WireConnection;76;0;74;0
WireConnection;0;0;76;0
WireConnection;0;1;75;0
WireConnection;0;3;71;0
WireConnection;0;4;56;45
WireConnection;0;5;56;200
WireConnection;0;9;59;0
WireConnection;0;12;57;0
WireConnection;0;16;58;0
ASEEND*/
//CHKSM=8A5C21FE6E0C28520FD6140463343A9181739357