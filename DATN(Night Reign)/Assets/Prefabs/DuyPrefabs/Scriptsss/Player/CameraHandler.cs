        ...
        public void HandleLockOn()
        {
            ...
            for (int k = 0; k < avilableTargets.Count; k++)
            {
                ...
                if (distanceFromTarget < shortestDistance)
                {
                    ...
                    nearestLockOnTarget = avilableTargets[k];
                }

                if (inputHandler.lockOnFlag && currentLockOnTarget)
                {
                    /* Vector3 relativeEnemyPosition = currentLockOnTarget.transform.InverseTransformPoint(avilableTargets[k].transform.position);
                    ...
                    Vector3 relativeEnemyPosition = inputHandler.transform.InverseTransformPoint(avilableTargets[k].transform.position);
                        ...
                        && avilableTargets[k] != currentLockOnTarget)
                    {
                        ...
                        leftLockOnTarget = avilableTargets[k];
                    }
                        ...
                        && avilableTargets[k] != currentLockOnTarget)
                    {
                        ...
                        rightLockOnTarget = avilableTargets[k];
                    }
                }
            }
        }
